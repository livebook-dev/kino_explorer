              ...
              <Container @drop="handleItemDrop" lock-axis="y" non-drag-area-selector=".field">
                ...
                >
                  <div :class="['operations', operation.operation_type]">
                    <BaseCard
                      :class="['operations-wrapper', operation.operation_type]"
                    ...
                    >
                      ...
                      <template v-slot:controls v-if="operation.operation_type !== 'pivot_wider'">
                        <button
                          ...
                          type="button"
                        >
                        <svg class="button-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                          <path fill="none" d="M0 0h24v24H0z"/>
                        ...
                        <button
                          ...
                          type="button"
                        >
                        <svg class="button-svg drag-move" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                          <defs>
                            <path fill="none" d="M0 0h24v24H0z"/>
