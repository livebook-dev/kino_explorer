export async function init(ctx, payload) {
    ...
    <div v-bind:class="[inline ? 'inline-field' : 'field', 'multiselect']">
      ...
      <div class="tags input">
        ...
        <div class="tag-controls">
          <button
            class="button button--sm icon-only clear-tags"
            @click="$emit('clearInnerValue')"
            type="button"
          >
            <svg
              class="tag-svg clear-tags-svg"
              fill="currentColor"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              width="12"
  ...
  const app = Vue.createApp({
                      ...
                      <template v-slot:content>
                        ...
                        <div class="row" v-if="operation.operation_type === 'pivot_wider'">
                          ...
                          <BaseMultiTagSelect
                            ...
                            @clear-inner-value="clearInnerValue(index, 'values_from', 'pivot_wider')"
                          />
                        </div>
                      </template>
    ...
    methods: {
      ...
      clearInnerValue(idx, field, operation_type) {
        ctx.pushEvent("update_field", {
          operation_type,
          field,
          value: [],
