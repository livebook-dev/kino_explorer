    ...
    template: `
      <div class="app">
        <div class="box box-warning" v-if="missingDep">
          <p>
            To successfully work with data frames, you need to add the following dependency:
          </p>
          <pre><code>{{ missingDep }}</code></pre>
        </div>
        <div class="box box-warning" v-if="noDataFrame">
          <p>To successfully work with DataFrameCell, you need at least one Explorer data frame available.</p>
          <p>For example:</p>
