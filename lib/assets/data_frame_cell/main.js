...
export function init(ctx, payload) {
  ...
  const app = Vue.createApp({
    components: { BaseSelect, BaseInput, Accordion },
    template: `
      <div class="app">
        ...
        <form @change="handleFieldChange">
          <div class="container">
            ...
            <div class="add-operation">
              <button class="button button--sm button--dashed" type="button" :disabled="noDataFrame" @click="addOperation('sorting')">
              ...
              <button class="button button--sm button--dashed" type="button" :disabled="noDataFrame" @click="addOperation('filters')">
                <svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4.41699 4.41602V0.916016H5.58366V4.41602H9.08366V5.58268H5.58366V9.08268H4.41699V5.58268H0.916992V4.41602H4.41699Z"/>
                </svg>
                Filter
